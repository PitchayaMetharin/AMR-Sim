"""Launch the Phase 14 composite robot for controller smoke testing."""
...
def generate_launch_description():
    ...
    spawn = Node(
        package="ros_gz_sim",
        executable="create",
        arguments=["-name", "phase14_mobile_manipulator", "-param", "robot_description"],
        parameters=[robot_description],
        output="screen",
    )
    joint_states = Node(
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(OnProcessExit(target_action=joint_states, on_exit=[arm_controller])),
